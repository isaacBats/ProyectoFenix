<!--
Esta Pagina fue elaborada por:	Daniel Bautista klonate@yahoo.com.mx
Para uso de: Fenix Farmacias en general y Clientes
el menu que se muestra en esta pag fue hecho con el codigo de la sig pag. : http://www.red-team-design.com/wp-content/uploads/2011/11/css3-animated-dropdown-menu-demo.html
y los efectos de fooder fueron tomados de esta otra: http://zurb.com/playground/reveal-modal-plugin
Copyright 2013, Isaac Daniel Batista ó Daniel Bautista.
Se autoriza copiar el codigo siempre y cuando reconoscan el trabajo de un servidor y le den el credito.
-->
		...
		function cambiarSlider(){
			...
			<footer id="pie">
				...
				<section class="legalfo">
					<a href="#" data-reveal-id="aviso">Aviso de Privacidad</a>
					 | 
					<a href="#" data-reveal-id="conuser">Condiciones para el usuario</a>
					 | 
					<a href="#" data-reveal-id="contac">Contacto</a>
			...
			<div id="aviso" class="reveal-modal">
				<p>
					...
					FARMACIAS EL FENIX DEL CENTRO, S.A. DE C.V. ó FARMACIAS EL FENIX, con domicilio en Lago Trasimeno 36, colonia Anáhuac, Delegación Miguel Hidalgo, 
			...
			<div id="conuser" class="reveal-modal">
				<p>
			...
			<div id="contac" class="reveal-modal">
				<p>
					<h2>Estamos a sus ordenes por los siguientes medios</h2>
					Lada sin costo 01 800 83 62 132<br>
					Conmutador 91 400 700 <br>
					Ext. 166, 651 &nbsp; &nbsp; &nbsp;&nbsp;Backoffice<br>
					Ext. 112, 677, 170	&nbsp;Sistemas.<br>
					Ext. 103 &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Recursos Humannos<br>
					Correo electónico: backoffice@farfenix.com.mx<br>
